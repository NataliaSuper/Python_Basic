...
print("Площадь треугольника", treugolnik1.areaTriangle())
print("Высота треугольника", treugolnik1.heightTriangle())
print("Периметр треугольника", treugolnik1.perimeterTriangle())
